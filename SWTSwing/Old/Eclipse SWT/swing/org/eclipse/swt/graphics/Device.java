...
public abstract class Device implements Drawable {
  ...
  public int internal_new_GC(GCData blabla) {
    throw new IllegalStateException("Not supported");
  }

  int computePixels(int height) {
    int hDC = internal_new_GC(null);
    int pixels = -Compatibility.round(height *
                                      OS.GetDeviceCaps(hDC, OS.LOGPIXELSY), 72);
...
//        OS.EnumFontFamilies(hDC, lpFaceName, lpEnumFontFamProc,
//                            scalable ? 1 : 0);
//      }
//    } else {
...
//        pixel = 0x02808080;
    ...
    return Color.swing_new(this, new java.awt.Color(pixel));
  }
...
//    hPalette = OS.CreatePalette(logPalette);
  ...
  public Graphics internal_new_GC() {
    // TODO: find how to implement that
//    Container handle = getHandle();
//    Graphics graphics = handle.getGraphics();
//    if(graphics == null) {
//      // TODO: force the realization of the component to not return null.
//    }
//    if(graphics == null) {
