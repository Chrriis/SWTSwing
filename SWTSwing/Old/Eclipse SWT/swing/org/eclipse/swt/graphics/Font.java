...
public final class Font {
  ...
  /**
   * The OS font resource.
   */
  public java.awt.Font swingHandle;
...
//    return new FontData[] {
//        FontData.win32_new(logFont, device.computePoints(logFont))};
  }
   ...
   */
  public static Font swing_new(Device device, java.awt.Font swingHandle) {
    if(device == null) {
      device = Device.getDevice();
    }
    Font font = new Font();
    font.swingHandle = swingHandle;
    font.device = device;
    return font;
  }
