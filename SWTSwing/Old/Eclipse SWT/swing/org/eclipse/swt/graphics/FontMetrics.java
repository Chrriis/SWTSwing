...
public final class FontMetrics {
  ...
  /**
   * The handle to the OS font metrics resource
   * (Warning: This field is platform dependent)
   */
  public java.awt.FontMetrics swingHandle;
...
//		handle.tmBreakChar == metric.tmBreakChar &&
  ...
  public int getAverageCharWidth() {
    // Pick a letter that looks average :)
    return swingHandle.charWidth('c');
  }
...
//        handle.tmPitchAndFamily ^ handle.tmCharSet;
  ...
  public static FontMetrics swing_new(java.awt.FontMetrics handle) {
    FontMetrics fontMetrics = new FontMetrics();
    fontMetrics.swingHandle = handle;
    return fontMetrics;
  }
