...
public class TabFolder extends Composite {
  ...
  static {
    ...
    pane.addTab("", panel);
    pane.doLayout();
    java.awt.Rectangle rec = panel.getBounds();
    leftTop = new Point((int)rec.getX(), (int)rec.getY());
    java.awt.Dimension dim = pane.getSize();
    rightBottom = new Point((int)(dim.getWidth() - rec.getWidth() - rec.getX()), (int)(dim.getHeight() - rec.getHeight() - rec.getY()));
  }
...
//  }
  ...
  void createItem(TabItem item, int index) {
    int count = swtTabbedPane.getTabbedPane().getTabCount();
    ...
    swtTabbedPane.getTabbedPane().add(new JPanel(new BorderLayout()), index);
...
//  }
  ...
  class SWTTabbedPane extends JLayeredPane {
    ...
    public void setBounds(int x, int y, int width, int height) {
      ...
      contentPane.setBounds(leftTop.x, leftTop.y, width - leftTop.x - rightBottom.x, height - leftTop.y - rightBottom.y);
  ...
  public int getItemCount() {
    checkWidget();
    return swtTabbedPane.getTabbedPane().getTabCount();
  }
  ...
  public TabItem[] getSelection() {
    checkWidget();
    int index = swtTabbedPane.getTabbedPane().getSelectedIndex();
    if(index == -1) {
  ...
  public int getSelectionIndex() {
    checkWidget();
    return swtTabbedPane.getTabbedPane().getSelectedIndex();
  }
...
//  }
  ...
  SWTTabbedPane swtTabbedPane;

  Container getNewHandle() {
    swtTabbedPane = new SWTTabbedPane();
    setContentPane(swtTabbedPane.getContentPane());
//    setSwingContainer(swtTabbedPane.getTabbedPane());
    swtTabbedPane.getTabbedPane().addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent e) {
        ...
        if(index != -1) {
          ...
          if(oldIndex != -1 && oldIndex != index) {
            TabItem oldItem = items[oldIndex]; 
            Control control = oldItem.control;
            if(control != null && !control.isDisposed()) {
    ...
    return swtTabbedPane;
  }

  void setSelection(int index, boolean notify) {
    JTabbedPane tabbedPane = swtTabbedPane.getTabbedPane();
