...
//    }
  ...
  public void setText(String string) {
    ...
    int tabIndex = parent.indexOf(this);
    if(tabIndex == -1) {
      return;
    }
    ...
    if(index != -1) {
      parent.swtTabbedPane.getTabbedPane().setMnemonicAt(tabIndex, string.charAt(index));
      string = string.substring(0, index - 1) + string.substring(index);
    }

    parent.swtTabbedPane.getTabbedPane().setTitleAt(tabIndex, string);
...
//    OS.HeapFree(hHeap, 0, pszText);
  ...
  public void setToolTipText(String string) {
    ...
    // This seems to not have any effect when the tabbed pane layout policy is "scroll"rather than wrap. SUN's bug?
    parent.swtTabbedPane.getTabbedPane().setToolTipTextAt(tabIndex, string == null? null: "<html>" + Utils.escapeHTML(string));
  }
